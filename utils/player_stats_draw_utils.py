...
def draw_player_stats(output_video_frames, player_stats):
    for index, row in player_stats.iterrows():
        ...
        avg_player_1_shot_speed = row.get('player_1_average_shot_speed', 0)
        avg_player_2_shot_speed = row.get('player_2_average_shot_speed', 0)
        avg_player_1_speed = row.get('player_1_average_player_speed', 0)
        avg_player_2_speed = row.get('player_2_average_player_speed', 0)
